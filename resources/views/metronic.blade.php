							...
							<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
								<ul class="kt-menu__nav ">
									...
									<li class="kt-menu__item kt-menu__item--rel">
                                        <a href="{{ route('order') }}" class="kt-menu__link">
									...
									<li class="kt-menu__item kt-menu__item--rel">
                                        <a href="{{ route('order.cancel') }}" class="kt-menu__link">
                                            <span class="kt-menu__link-text">Cancel Order</span>
                                        </a>
                                    </li>
									@endcan
									<li class="kt-menu__item kt-menu__item--rel">
          							...
          							@can('sync', Auth::user())
									<li class="kt-menu__item kt-menu__item--rel">
                                        <a href="{{ route('sync') }}" class="kt-menu__link">
                                            <span class="kt-menu__link-text">Integrations</span>
                                        </a>
                                    </li>
									@endcan
          							@can('list', Auth::user())
									...
									<li class="kt-menu__item kt-menu__item--rel">
                                        <a href="{{ route('product') }}" class="kt-menu__link">
